...
export const PreventBlindness = () => {
  ...
  <div style="display:flex;flex-direction:row;gap:1rem;">
    ...
    <osl-tabs>
      <div data-tab="Counties" style="position:relative;width:100%;height:100%;">
        <osl-glmap 
      ...
      <div data-tab="Zip Codes (ZCTAs)" style="position:relative;width:100%;height:100%;">
      </div>
      <div data-tab="Congressional Districts" style="position:relative;width:100%;height:100%;">
      </div>
    </osl-tabs>
