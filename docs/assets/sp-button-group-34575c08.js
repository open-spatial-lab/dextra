import{B as i}from"./ButtonBase-6b15501f.js";import{i as l,x as p}from"./lit-element-47511895.js";import{a as d,S as v}from"./ValtioElement-af4c0565.js";import{n}from"./safeCustomElement-f1504f3f.js";const h=l`
...
`,g=h;var f=Object.defineProperty,y=Object.getOwnPropertyDescriptor,b=(c,t,r,e)=>{for(var o=e>1?void 0:e?y(t,r):t,u=c.length-1,s;u>=0;u--)(s=c[u])&&(o=(e?s(t,r,o):s(o))||o);return e&&o&&f(t,r,o),o};const k=["accent","primary","secondary","negative","white","black"];class a extends d(i){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,g]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":this.removeAttribute("variant"),this.static="white",this.treatment="outline";return;case"white":case"black":this.static=t,this.removeAttribute("variant");return;case null:return;default:k.includes(t)?this._variant=t:this._variant="accent";break}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}b([n()],a.prototype,"variant",1),b([n({type:String,reflect:!0})],a.prototype,"static",2),b([n({reflect:!0})],a.prototype,"treatment",2),b([n({type:Boolean})],a.prototype,"quiet",1);customElements.define("sp-button",a);const w=l`
...
`,x=w;var z=Object.defineProperty,q=Object.getOwnPropertyDescriptor,B=(c,t,r,e)=>{for(var o=e>1?void 0:e?q(t,r):t,u=c.length-1,s;u>=0;u--)(s=c[u])&&(o=(e?s(t,r,o):s(o))||o);return e&&o&&z(t,r,o),o};class m extends d(v){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[x]}handleSlotchange({target:t}){t.assignedElements().forEach(r=>{r.size=this.size})}render(){return p`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}B([n({type:Boolean,reflect:!0})],m.prototype,"vertical",2);customElements.define("sp-button-group",m);
//# sourceMappingURL=sp-button-group-34575c08.js.map
