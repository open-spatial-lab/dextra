import"./sp-icon-alert-c2c8caf1.js";import{i as h,x as s,A as u}from"./lit-element-47511895.js";import{a as m,S as x}from"./ValtioElement-af4c0565.js";import{n as a}from"./safeCustomElement-f1504f3f.js";const v=h`
...
--spectrum-helptext-disabled-content-color
)}:host(:lang(ja)),:host(:lang(ko)),:host(:lang(zh)){--spectrum-helptext-line-height-cjk:var(--spectrum-line-height-cjk-100)}:host([size=s]){--spectrum-helptext-min-height:var(--spectrum-component-height-75);--spectrum-helptext-icon-size:var(--spectrum-workflow-icon-size-75);--spectrum-helptext-font-size:var(--spectrum-font-size-75);--spectrum-helptext-text-to-visual:var(--spectrum-text-to-visual-75);--spectrum-helptext-top-to-workflow-icon:var(
...
`,d=v;var f=Object.defineProperty,g=Object.getOwnPropertyDescriptor,i=(r,e,c,o)=>{for(var t=o>1?void 0:o?g(e,c):e,l=r.length-1,p;l>=0;l--)(p=r[l])&&(t=(o?p(e,c,t):p(t))||t);return o&&t&&f(e,c,t),t};class n extends m(x){constructor(){super(...arguments),this.icon=!1,this.variant="neutral"}static get styles(){return[d]}render(){return s`
            ${this.variant==="negative"&&this.icon?s`
                      <sp-icon-alert class="icon"></sp-icon-alert>
                  `:u}
            <div class="text"><slot></slot></div>
        `}}i([a({type:Boolean,reflect:!0})],n.prototype,"icon",2),i([a({reflect:!0})],n.prototype,"variant",2);customElements.define("sp-help-text",n);
//# sourceMappingURL=sp-help-text-e5f96728.js.map
