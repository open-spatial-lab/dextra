import{B as c}from"./ButtonBase-6b15501f.js";import{t as e,I as t,s as o}from"./ValtioElement-af4c0565.js";import{x as a,i as n}from"./lit-element-47511895.js";class x extends c{}const l=({width:s=24,height:i=24,title:r="Cross75"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`;class h extends t{render(){return o(a),l()}}customElements.define("sp-icon-cross75",h);const u=({width:s=24,height:i=24,title:r="Cross100"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`;class m extends t{render(){return o(a),u()}}customElements.define("sp-icon-cross100",m);const d=({width:s=24,height:i=24,title:r="Cross200"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`;class p extends t{render(){return o(a),d()}}customElements.define("sp-icon-cross200",p);const g=({width:s=24,height:i=24,title:r="Cross300"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`;class w extends t{render(){return o(a),g()}}customElements.define("sp-icon-cross300",w);const v=n`
...
`,L=v;export{L as I,x as S};
//# sourceMappingURL=spectrum-icon-cross.css-7c034bb2.js.map
